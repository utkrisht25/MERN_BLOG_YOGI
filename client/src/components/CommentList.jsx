    ...
    return (
        <div>
            ...
            <div className='mt-5'>
                ...
                {/* this trick is to reduce the load on the api , we directly update the comment list , first the comment will rendered here and
                at the same time it will be added in the databse */}
                ...
                {props.newComment
                 ...
                 {/* here we are adding new comments in database and this content is rendered when we call the api  */}
